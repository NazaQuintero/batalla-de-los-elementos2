...
Personaje* FabricaDePersonaje::obtenerPersonaje(string elemento, string nombre, int escudo, int vida, int posX, int posY) {
	...
	if (elemento == "agua") {
		...
		personaje = new Agua(nombre, escudo, vida, posX, posY);

	} else if (elemento == "fuego") {

		personaje = new Fuego(nombre, escudo, vida, posX, posY);

	} else if (elemento == "tierra") {

		personaje = new Tierra(nombre, escudo, vida, posX, posY);

	} else if (elemento == "aire") {

		personaje = new Aire(nombre, escudo, vida, posX, posY);
